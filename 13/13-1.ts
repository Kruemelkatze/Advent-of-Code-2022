...
const pairLines = chunkArrayByValue(inputLines, "");
const pairs = pairLines.map(([str1, str2]) => [JSON.parse(str1), JSON.parse(str2)]);

let correctIndices = new Array<number>();
...
console.log("Correct indices:")
console.dir(correctIndices);
